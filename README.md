...
- 0.2.5: Fixing sandbox escape via `evalWithGlobalScope()` where assertSafeScope was not called, allowing unrestricted Java class access [#35](https://github.com/javadelight/delight-rhino-sandbox/issues/35)
